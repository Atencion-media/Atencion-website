export const Testimonials = [
  {
    title: "Pradnya Gore , Managing Director at Smita Holidays",
    description:
  ...
  },
  {
    ...
    description:
      "At Sambhajinagar there is a well known International Festival organized by the Ellora Ajanta International Festival. So for social Media we took help from them. The team made this all possible with very short time and up to the mark and handled the event very gracefully for the Purvarang Curtain Raiser.The theme design and social media presence created a value and engaging audience for the main festival.",
    imageUrl:
  ...
  {
    title: "Rohan Changede, Founder of Vista Journeys",
    description:
  ...
  },
  {
    ...
    description:
      "Thrilled with the results! Our abroad consultancy's campus marketing campaign reached new heights thanks to the exceptional work by Atencion Media.They saved our efforts and delivered good results in minimum investment.  Their innovative strategies and dedication brought our services directly to our target audience. Couldn't be happier!",
    imageUrl:
      "https://res.cloudinary.com/dlr4rgxrt/image/upload/v1720555228/logo-siec_tunleu.png",
  },
  {
    title: "Rahul Mugdyal , Senior Marketing Manager, AECC",
    description:
